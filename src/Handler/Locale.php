...
class Locale extends Debug
{
    ...
    private function importUniqueDefault() 
    {
        ...
        if(file_exists($file)) 
        {
            ...
            $this->getLogger()->info("Imported $i unique values from default locale '$default'.");
            $this->extended = true;
        }
        else $this->getLogger()->warning("Cannot import unique default values, due to not existing default locale '$default' file.");
    }
